...
ncG3=[];
  ...
  for i=3,%:length(t),
    ...
    [TabH1,TabH3,BDH1,BDH3,tar_darH,d2s1,d2s3,cE1,cE3,GE1,GE3,numH,distH1,distH3]=thrExpr_EcM_Dif_dist_GEint_ind_2(thr_vic,thrExS,thrExE,gene_names,geneEc_chrN,geneM_chrN,ind_geneEcN,ind_geneMN,vec_EcN,vec_MN,dar1,dar3,chrN);
  ...
  for i=2,%:length(t),
    ...
    [TabM1,TabM3,BDM1,BDM3,tar_darM,d2s1,d2s3,cE1,cE3,GE1,GE3,numM,distM1,distM3]=thrExpr_EcM_Dif_dist_GEint_ind_2(thr_vic,thrExS,thrExE,gene_names,geneEc_chrN,geneM_chrN,ind_geneEcN,ind_geneMN,vec_EcN,vec_MN,dar1,dar3,chrN);
  ...
  for i=1,%:length(t),
    ...
    [TabL1,TabL3,BDL1,BDL3,tar_darL,d2s1,d2s3,cE1,cE3,GE1,GE3,numL,distL1,distL3]=thrExpr_EcM_Dif_dist_GEint_ind_2(thr_vic,thrExS,thrExE,gene_names,geneEc_chrN,geneM_chrN,ind_geneEcN,ind_geneMN,vec_EcN,vec_MN,dar1,dar3,chrN);
  ...
  % me1_me3_H=[mean(distH1),mean(distH3)];
   ...
   %[newh_cGE1,newh_cGE3,nghw1,nghw3]=normalise_countEnh(TabH1,TabH3);
    ...
    %bbed_dar3=bed_dar3;
       ...
       %pm=pM(1,2);
       %[rEn_d pEn]=corrcoef(t,denn_EcM(:,2));
...
%============================subfunctions
function [Tab_G1_DAR1,Tab_G3_DAR3,bed_dar1,bed_dar3,tar_dar,d2s1,d2s3,cE1,cE3,GE1,GE3,num,dist1,dist3]=thrExpr_EcM_Dif_dist_GEint_ind_2(thr_vic,thrExS,thrExE,gene_names,geneEc_chrN,geneM_chrN,ind_geneEcN,ind_geneMN,vec_EcN,vec_MN,dar1,dar3,chrN)
...
%display(' Mes for this thrEx');
  if min(size(G3In_exp))>0,
    ...
    display([' no data for GE3 this thrE=',num2str(thrExS)]);
  end
  ...
  if size(Tab_G1_DAR1)>0 & size(Tab_G3_DAR3) >0,
   ...
   %BD= chr dar_st dar_end gene_ind TSS TES dir  GE'); 8 fields
    ...
    display(['no data GE1 or GE3 for these thrE and vicinity=',num2str(thr_vic)]);
  end
end % function
